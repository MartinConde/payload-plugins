 ...
 */ export const buildColorSwatchesCollection = ({ slug, mediaCollectionSlug, overrides })=>({
        slug,
        labels: {
        ...
        fields: [
            ...
            },
            {
                ...
                admin: {
                    description: productsT('pluginProducts:colorSwatchHexDesc')
                },
                validate: (value)=>{
            ...
            },
            {
                ...
                admin: {
                    description: productsT('pluginProducts:colorSwatchSwatchDesc')
                }
            },
            {
                name: 'family',
                ...
                options: [
                    {
                        value: 'red',
                        label: productsT('pluginProducts:colorFamilyRed')
                    },
                    {
                        value: 'orange',
                        label: productsT('pluginProducts:colorFamilyOrange')
                    },
                    {
                        value: 'yellow',
                        label: productsT('pluginProducts:colorFamilyYellow')
                    },
                    {
                        value: 'green',
                        label: productsT('pluginProducts:colorFamilyGreen')
                    },
                    {
                        value: 'blue',
                        label: productsT('pluginProducts:colorFamilyBlue')
                    },
                    {
                        value: 'purple',
                        label: productsT('pluginProducts:colorFamilyPurple')
                    },
                    {
                        value: 'neutral',
                        label: productsT('pluginProducts:colorFamilyNeutral')
                    },
                    {
                        value: 'white',
                        label: productsT('pluginProducts:colorFamilyWhite')
                    },
                    {
                        value: 'black',
                        label: productsT('pluginProducts:colorFamilyBlack')
                    },
                    {
                        value: 'multi',
                        label: productsT('pluginProducts:colorFamilyMulti')
                    }
                ]
            },
            {
