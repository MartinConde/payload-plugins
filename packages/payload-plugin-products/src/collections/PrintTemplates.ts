 ...
 */
export const buildPrintTemplatesCollection = ({
  slug,
  overrides,
}: BuildPrintTemplatesCollectionOptions): CollectionConfig => ({
  slug,
  labels: {
  ...
  admin: {
    useAsTitle: 'name',
    defaultColumns: ['name', 'widthMm', 'heightMm', 'category', 'updatedAt'],
  ...
  fields: [
    {
      ...
      admin: { description: productsT('pluginProducts:printTemplateNameDesc') },
    },
    {
      name: 'widthMm',
      type: 'number',
