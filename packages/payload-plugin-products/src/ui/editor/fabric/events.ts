/* Canvas-level event wiring helpers. Keeps the canvas-init effect terse and
   centralises the v6 quirks (uniform-scale enforcement, etc.). */
...
export function wireUniformScaling(canvas: Canvas): () => void {
...
export function clampObjectToCanvas(target: FabricObject, canvas: CanvasSize): void {
