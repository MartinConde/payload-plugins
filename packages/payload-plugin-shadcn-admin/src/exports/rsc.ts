...
/* Root-level Account + auth views (installed by the `defaultAuthViews` option
   ...
   absent — they aren't cleanly overridable in Payload 3.84.1. */
...
export {
  AutoLogoutView,
  AutoLogoutInactivityView,
} from '../features/auth/AutoLogoutView.js'
...
/* Folder views (installed by the `defaultFolderView` option at
   `admin.components.views.browseByFolder`). */
