...
} from '../features/nav/CollectionsSidebarGroup.js'
export {
  DefaultAdminSidebar,
  type AdminBranding,
...
/* Sidebar primitives re-exported from the plugin so the consumer's sidebar
   ...
   AdminProviders/SidebarProvider and ViewHeader/SidebarTrigger. */
export {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
export {
  ...
  DEFAULT_PAGE_SIZE,
} from '../features/list-view/prefs/useDataTableUrlState.js'
...
export {
  ...
  type FilterState,
  type WhereOperator,
} from '../features/list-view/filters/useFilterUrlState.js'

export { usePreferencesSync } from '../features/list-view/prefs/usePreferencesSync.js'

export {
  useColumnPrefs,
  type UseColumnPrefsReturn,
} from '../features/list-view/prefs/useColumnPrefs.js'

export { resolveColumnOrder } from '../features/list-view/columns/resolveColumnOrder.js'

export {
  CollectionListViewClient,
  type CollectionListViewClientProps,
} from '../features/list-view/CollectionListViewClient.js'
...
export {
  ...
  PRESET_ERROR,
  type Preset,
} from '../features/list-view/filters/usePresets.js'

/* CSV export */
export {
  ExportMenu,
  type ExportMenuProps,
} from '../features/list-view/export/ExportMenu.js'
export {
  FieldPickerSheet,
  type ExportScope,
  type ExportFieldChoice,
  type FieldPickerSheetProps,
} from '../features/list-view/export/FieldPickerSheet.js'

/* Versions / diff workflow */
export {
  VersionsList,
  type VersionRow,
  type VersionsListProps,
} from '../features/doc-form/versions/VersionsList.js'
export {
  SelectComparison,
  type ComparisonOption,
} from '../features/doc-form/versions/SelectComparison.js'
...
export {
  ...
  type BulkEditableCollection,
} from '../features/list-view/bulk/BulkEditSheet.js'
export {
  BulkEditFieldInput,
  isBulkEditable,
  type BulkEditField,
  type BulkEditSelectOption,
} from '../features/list-view/bulk/BulkEditFieldInput.js'
...
/* Doc-form extension surface. `FieldInputProps` is the prop shape every
   ...
   active locale to slice individually-localized subfield values. */
export {
  FieldInput,
  SearchableSelect,
  type FieldInputProps,
  type FieldInputField,
} from '../features/doc-form/inputs/FieldInput.js'
export {
  UploadFieldInput,
  type UploadFieldInputProps,
} from '../features/doc-form/inputs/UploadFieldInput.js'
/* Doc-form access for `.input` overrides. These hooks (and the active-locale /
   ...
   replacement. The admin bridge mounts the corresponding Providers. */
export {
  useActiveLocale,
