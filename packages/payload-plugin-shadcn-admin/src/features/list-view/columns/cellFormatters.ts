/* Pure, non-React formatting helpers for auto-generated list-view cells: date/
   ...
   builder that call these. */

import type { AutoField } from './autoColumns.js'

export const EM_DASH = '—'

export const stringifyLabel = (value: unknown): string | null => {
...
export const labelFor = (field: AutoField, fallback: string): string =>
...
export const formatDate = (value: unknown, displayFormat?: string): string => {
...
export const extractLexicalText = (value: unknown, maxChars: number): string => {
  const parts: string[] = []
...
export const summarizeArray = (value: unknown, field: AutoField): string => {
...
export const summarizeBlocks = (value: unknown): string => {
  if (!Array.isArray(value)) return EM_DASH
  const n = value.length
...
export const summarizeGroup = (value: unknown): string => {
...
export const formatPoint = (value: unknown): string => {
