...
/* Seed top-level static field defaults so the first-user form starts from the
   ...
   tabs/groups are left to the user. */
...
/* RSC installed at `admin.components.views.createFirstUser`. Extracts the user
   ...
   form. Mounted as `payload-plugin-shadcn-admin/rsc#AutoCreateFirstUserView`. */
export function AutoCreateFirstUserView({ initPageResult }: AdminViewServerProps) {
