...
import { toast } from '../../internal/payloadAdapterUI.js'
...
import { canRead, subPerms, type Perms } from './access-control/fieldPermissions.js'
import {
  isJsonParseError,
...
export const focusFirstError = (errs: Record<string, string>): void => {
...
export const buildAuthCreateFields = (): ExtractedField[] => [
  {
    type: 'text',
    name: '__password',
    label: 'Password',
...
/* Finds a top-level-NAMED `blocks` field anywhere in the schema — including
   ...
   there keeps this a cheap targeted lookup rather than a full-schema walk. */
...
export const rekeyRichTextOnRowMove = (
...
export const findJsonParseError = (
  value: unknown,
  prefix: string,
...
export const collectRequiredEmptyPaths = (
  fields: ExtractedField[],
  values: unknown,
  prefix: string,
  parentPerms: Perms,
...
export const seedDefaults = (fields: ExtractedField[]): Record<string, unknown> => {
...
export const collectTopLevelKeys = (fields: ExtractedField[]): Set<string> => {
