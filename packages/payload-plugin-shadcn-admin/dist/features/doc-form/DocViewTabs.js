...
/* Restyled replacement for Payload's default DocumentHeader tabs
   ...
   (the RSC passes `Boolean(config.versions)`). */ export function DocViewTabs({ active = 'edit', hasVersions = true } = {}) {
    ...
    const tab = cn(buttonVariants({
        variant: 'ghost',
        size: 'sm'
    }), 'text-muted-foreground hover:text-foreground');
    const activeTab = cn(buttonVariants({
        variant: 'secondary',
        size: 'sm'
    }));
    const classFor = (key)=>key === active ? activeTab : tab;
    const currentFor = (key)=>key === active ? 'page' : undefined;
    return /*#__PURE__*/ _jsxs("nav", {
        ...
        children: [
            /*#__PURE__*/ _jsx("a", {
                ...
                "aria-current": currentFor('edit'),
                children: t('general:edit')
            }),
            hasVersions ? /*#__PURE__*/ _jsxs("a", {
                href: `${base}/versions`,
                className: classFor('versions'),
                "aria-current": currentFor('versions'),
                children: [
                    t('version:versions'),
                    typeof versionCount === 'number' && versionCount > 0 && /*#__PURE__*/ _jsx(Badge, {
                        variant: "secondary",
                        className: "ml-1.5",
