...
export function LayersPanel({ rows, blocks, onReorder, onDuplicate, onDelete, disabled }) {
    ...
    return /*#__PURE__*/ _jsxs("div", {
        className: "flex h-full w-56 shrink-0 flex-col gap-2 overflow-y-auto border-r pr-3",
        children: [
            /*#__PURE__*/ _jsx("span", {
...
function LayerRow({ row, index, label, preview, selected, disabled, onSelect, onDuplicate, onDelete, dragLabel, duplicateLabel, deleteLabel }) {
    ...
    return /*#__PURE__*/ _jsxs("div", {
        ref: setNodeRef,
        style: style,
        className: cn('flex items-center gap-1 rounded-md border px-1 py-1', selected ? 'border-primary bg-accent' : 'border-transparent hover:bg-accent/50'),
        children: [
