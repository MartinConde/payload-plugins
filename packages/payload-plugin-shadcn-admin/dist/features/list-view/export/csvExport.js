/* Pure CSV serialization helpers. No React. Used by ExportMenu to
   project an arbitrary array of Payload docs into a downloadable CSV. */ const CSV_NEEDS_QUOTE_RE = /[",\r\n]/;
...
/* Coerce a single field value to a CSV cell string. Strategy:
   ...
   - Anything else (arrays, objects, relationship objects, polymorphic
     ...
     JSON.stringify(). Lossless and predictable. */ export const coerceCellValue = (_field, raw)=>{
...
/* BOM-prefixed so Excel opens UTF-8 cleanly. CRLF line endings per RFC 4180. */ export const rowsToCsv = (headers, rows)=>{
    const lines = [];
