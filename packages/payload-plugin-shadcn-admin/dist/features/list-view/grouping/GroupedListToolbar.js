...
/* v3.23 — shared toolbar for the grouped list view: search + create, sitting
   ...
   merged back in on the next render — deleting never actually clears it. */ import * as React from 'react';
...
export function GroupedListToolbar({ newDocumentURL, enableCreate, enableSearch, initialSearch, searchPlaceholder, searchDebounceMs = 300 }) {
    ...
    const { isInDrawer, allowCreate: drawerAllowCreate, DocumentDrawerToggler } = useListDrawerContext();
    ...
    return /*#__PURE__*/ _jsxs("div", {
        ...
        children: [
            enableSearch ? /*#__PURE__*/ _jsxs("div", {
            ...
            createButton ? /*#__PURE__*/ _jsx("div", {
                className: "ml-auto",
