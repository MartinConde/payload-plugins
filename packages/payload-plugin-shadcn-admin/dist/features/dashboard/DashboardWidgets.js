...
/* Widget content for the two built-in dashboard widgets. No 'use client'
   ...
   opaque nodes around, not re-render their contents). */ import * as React from 'react';
...
export function RecentlyUpdatedWidget({ recent, title }) {
...
export function CollectionsWidget({ sections }) {
    return /*#__PURE__*/ _jsx("div", {
        className: "space-y-8",
        children: sections.map((section)=>/*#__PURE__*/ _jsxs("section", {
                className: "space-y-3",
                children: [
                    /*#__PURE__*/ _jsx("h2", {
