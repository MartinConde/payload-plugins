 ...
 */ export const buildRedirectsCollection = ({ slug, collections, overrides })=>({
        slug,
        ...
        fields: [
            {
                ...
                admin: {
                    description: seoT('pluginSeo:fromDesc')
                }
            },
            {
                name: 'to',
                ...
                fields: [
                    {
                        ...
                        options: [
                            {
                                label: seoT('pluginSeo:relInternal'),
                                value: 'internal'
                            },
                            {
                                label: seoT('pluginSeo:relCustom'),
                                value: 'custom'
                            }
                        ]
                    },
                    {
                        ...
                        admin: {
                            condition: (_, siblingData)=>siblingData?.relationshipType === 'internal'
                        }
                    },
                    {
                        name: 'url',
                        ...
                        admin: {
                            condition: (_, siblingData)=>siblingData?.relationshipType === 'custom'
                        }
                    }
                ]
            },
            {
                ...
                options: [
                    {
                        label: seoT('pluginSeo:type301'),
                        value: '301'
                    },
                    {
                        label: seoT('pluginSeo:type302'),
                        value: '302'
                    }
                ]
            }
