...
/* Presentational launch card for the setup wizard. A `ui` field (Payload's
   ...
   so it stores no data and never appears in the generated types. */ const wizardLauncherField = {
    name: 'seoWizardLauncher',
    type: 'ui',
    admin: {},
    custom: {
        'plugin-shadcn-admin': {
            input: SeoWizardLaunch
        }
    }
};
/** Common `og:locale` codes (language_TERRITORY). Rendered as a searchable
 *  combobox by shadcn-admin since the list is long. */ export const OG_LOCALE_OPTIONS = [
    {
    ...
    {
        label: 'Spanish (Spain) — es_ES',
        value: 'es_ES'
    },
    {
        label: 'Spanish (Latin America) — es_419',
        value: 'es_419'
    },
    {
        label: 'Italian — it_IT',
    ...
    {
        label: 'Portuguese (Portugal) — pt_PT',
        value: 'pt_PT'
    },
    {
        label: 'Polish — pl_PL',
 ...
 */ export const buildSeoSettingsGlobal = ({ slug, uploadsCollection, templateCollections, wizard = true })=>({
        slug,
        ...
        admin: {
            description: seoStatic('pluginSeo:settingsDesc')
        },
        fields: [
            ...wizard ? [
                wizardLauncherField
                                ...
                                fields: [
                                    {
                                        ...
                                        admin: {
                                            description: seoT('pluginSeo:defaultTwitterCardDesc')
                                        },
                                        options: [
                                            {
                                ...
                                fields: [
                                    {
                                        ...
                                        options: [
                                            {
                                                label: seoT('pluginSeo:cfAlways'),
                                                value: 'always'
                                            },
                                            {
                                                label: seoT('pluginSeo:cfHourly'),
                                                value: 'hourly'
                                            },
                                            {
                                                label: seoT('pluginSeo:cfDaily'),
                                                value: 'daily'
                                            },
                                            {
                                                label: seoT('pluginSeo:cfWeekly'),
                                                value: 'weekly'
                                            },
                                            {
                                                label: seoT('pluginSeo:cfMonthly'),
                                                value: 'monthly'
                                            },
                                            {
                                                label: seoT('pluginSeo:cfYearly'),
                                                value: 'yearly'
                                            },
                                            {
                                                label: seoT('pluginSeo:cfNever'),
                                                value: 'never'
                                            }
                                        ]
                                    },
