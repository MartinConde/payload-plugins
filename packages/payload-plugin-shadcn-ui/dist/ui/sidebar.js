...
import { useIsMobile } from "../shared/use-mobile.js";
...
function SidebarInset({ className, ...props }) {
    return /*#__PURE__*/ _jsx("main", {
        ...
        className: cn("relative flex w-full flex-1 flex-col bg-background", "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-lg md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2", className),
        ...props
    });
}
