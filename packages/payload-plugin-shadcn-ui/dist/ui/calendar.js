...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
    return /*#__PURE__*/ _jsx(DayPicker, {
        ...
        // `relative` anchors the absolutely-positioned prev/next nav buttons to
        // the calendar (flanking the month caption) instead of the nearest
        // positioned ancestor (e.g. a tall popover).
        ...
        classNames: {
            ...
            day: cn("relative p-0 text-center text-sm focus-within:relative focus-within:z-20", "h-8 w-8"),
        ...
        components: {
            Chevron: ({ orientation, ...iconProps })=>orientation === "left" ? /*#__PURE__*/ _jsx(ChevronLeftIcon, {
                    className: "size-4",
                    ...iconProps
